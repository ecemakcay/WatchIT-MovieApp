...
public class WatchedMoviesFragment extends Fragment {
    ...
    public void getWatchedMovies(){
        ...
        firestoreHelper.getMovies(userId, "WatchedMovies", new FirestoreHelper.GetMoviesListener() {
            @SuppressLint("NotifyDataSetChanged")
            @Override
            public void onMoviesLoaded(List<MovieModel> watchedMovies) {
                movieList.clear();
                movieList.addAll(watchedMovies);
